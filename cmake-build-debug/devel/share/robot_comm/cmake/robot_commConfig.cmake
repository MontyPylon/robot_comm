  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_comm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'montypylon <montypylon@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/montypylon/soccer_robot_ws/src/robot_comm/${idir}'.  Ask the maintainer 'montypylon <montypylon@todo.todo>' to fix it.")
    endif()
