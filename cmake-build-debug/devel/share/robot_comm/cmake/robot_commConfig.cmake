...
if("TRUE" STREQUAL "TRUE")
  set(robot_comm_SOURCE_PREFIX /home/montypylon/soccer_robot_ws/src/robot_comm)
  set(robot_comm_DEVEL_PREFIX /home/montypylon/soccer_robot_ws/src/robot_comm/cmake-build-debug/devel)
  ...
  set(robot_comm_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/montypylon/soccer_robot_ws/src/robot_comm/cmake-build-debug/devel/include " STREQUAL " ")
  set(robot_comm_INCLUDE_DIRS "")
  set(_include_dirs "/home/montypylon/soccer_robot_ws/src/robot_comm/cmake-build-debug/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_comm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jeremy Cook <jeremycook97@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/montypylon/soccer_robot_ws/src/robot_comm/${idir}'.  Ask the maintainer 'Jeremy Cook <jeremycook97@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/montypylon/soccer_robot_ws/src/robot_comm/cmake-build-debug/devel/lib;/home/montypylon/soccer_robot_ws/devel/lib;/home/montypylon/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(robot_comm_EXPORTED_TARGETS "robot_comm_generate_messages_cpp;robot_comm_generate_messages_lisp;robot_comm_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robot_comm_dep}_FOUND)
      find_package(${robot_comm_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_comm_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "robot_comm-msg-extras.cmake")
